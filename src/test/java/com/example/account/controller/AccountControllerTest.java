...
class AccountControllerTest extends IntegrationTestSupport {
    ...
    @Test
    public void testCreateAccount_whenCustomerIdExists_shouldCreateAccountReturnAccountDto() throws Exception {
    ...
    @Test
    public void testCreateAccount_whenCustomerIdDoesNotExist_shouldReturnNotFound() throws Exception {
    ...
    @Test
    public void testCreateAccount_whenCustomerIdIsNotPresent_shouldReturnBadRequest() throws Exception {
    ...
    @Test
    public void testCreateAccount_whenInitialCreditIsLessThanZero_shouldReturnBadRequest() throws Exception {
        CreateAccountRequest request = generateCreateAccountRequest("id",-2000);
        this.mockMvc.perform(post(ACCOUNT_API_ENDPOINT)
                .contentType(MediaType.APPLICATION_JSON)
